...
namespace NavigationUsingRegionsDemo.ViewModels.Commands
{
    /// <summary>
    ...
    public interface ICommandMap
    {
        ...
        void AddCommand(string commandName, Action<object> executeMethod, Predicate<object> canExecuteMethod);
